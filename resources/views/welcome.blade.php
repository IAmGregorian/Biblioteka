                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
                                    <div class="card style-2 mb-md-0 mb-4">
                                        <img src="{{ asset ('assets/src/assets/img/masonry-blog-style-3.jpg') }}" class="card-img-top" alt="...">
                                        <div class="card-body px-0 pb-0">
                                            <h5 class="card-title mb-3">Excessive sugar is harmful</h5>
                                            <div class="media mt-4 mb-0 pt-1">
                                                <img src="{{ asset ('assets/src/assets/img/profile-14.jpg') }}" class="card-media-image me-3" alt="">
                                ...
                                <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
                                    <div class="card style-2 mb-md-0 mb-4">
                                        <img src="{{ asset ('assets/src/assets/img/grid-blog-style-2.jpg') }}" class="card-img-top" alt="...">
                                        <div class="card-body px-0 pb-0">
                                            <h5 class="card-title mb-3">Creative Photography</h5>
                                            <div class="media mt-4 mb-0 pt-1">
                                                <img src="{{ asset ('assets/src/assets/img/profile-21.jpg') }}" class="card-media-image me-3" alt="">
                                                <div class="media-body">
                                ...
                                <div class="col-lg-3 col-md-6 mb-md-0 mb-4">
                                    <div class="card style-2 mb-md-0 mb-4">
                                        <img src="{{ asset ('assets/src/assets/img/list-blog-style-3.jpg') }}" class="card-img-top" alt="...">
                                        <div class="card-body px-0 pb-0">
                                            <h5 class="card-title mb-3">Plan your next trip</h5>
                                            <div class="media mt-4 mb-0 pt-1">
                                                <img src="{{ asset ('assets/src/assets/img/profile-2.jpg') }}" class="card-media-image me-3" alt="">
                                                <div class="media-body">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card style-2 mb-md-0 mb-4">
                                        <img src="{{ asset ('assets/src/assets/img/masonry-blog-style-4.jpg') }}" class="card-img-top" alt="...">
                                        <div class="card-body px-0 pb-0">
                                            <h5 class="card-title mb-3">My latest Vlog</h5>
                                            <div class="media mt-4 mb-0 pt-1">
                                                <img src="{{ asset ('assets/src/assets/img/profile-13.jpg') }}" class="card-media-image me-3" alt="">
                                                <div class="media-body">
