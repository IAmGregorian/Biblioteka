                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="{{ asset ('assets/src/assets/img/profile-16.jpg') }}" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="{{ asset ('assets/src/assets/img/profile-15.jpg') }}" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="{{ asset ('assets/src/assets/img/profile-21.jpg') }}" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="auth-boxed-lockscreen.html') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> <span>?1/fasdFTBA?</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="{{ ('assets/index.html') }}" class="nav-link"> CORK </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/index.html') }}"> Analytics </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/index2.html') }}"> Sales </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="apps" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/app-calendar.html') }}"> Calendar </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-chat.html') }}"> Chat </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-mailbox.html') }}"> Mailbox </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-todoList.html') }}"> Todo List </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-notes.html') }}"> Notes </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-scrumboard.html') }}"> Scrumboard </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/app-contacts.html') }}"> Contacts </a>
                            </li>
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="invoice" data-bs-parent="#apps"> 
                                    <li>
                                        <a href="{{ ('assets/app-invoice-list.html') }}"> List </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-invoice-preview.html') }}"> Preview </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-invoice-add.html') }}"> Add </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-invoice-edit.html') }}"> Edit </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="ecommerce" data-bs-parent="#apps"> 
                                    <li>
                                        <a href="{{ ('assets/app-ecommerce-product-shop.html') }}"> Shop </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-ecommerce-product.html') }}"> Product </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-ecommerce-product-list.html') }}"> List </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-ecommerce-product-add.html') }}"> Create </a>
                                    </li>                            
                                    <li>
                                        <a href="{{ ('assets/app-ecommerce-product-edit.html') }}"> Edit </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="blog" data-bs-parent="#apps"> 
                                    <li>
                                        <a href="{{ ('assets/app-blog-grid.html') }}"> Grid </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-blog-list.html') }}"> List </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-blog-post.html') }}"> Post </a>
                                    </li>
                                    <li>
                                        <a href="{{ ('assets/app-blog-create.html') }}"> Create </a>
                                    </li>                            
                                    <li>
                                        <a href="{{ ('assets/app-blog-edit.html') }}"> Edit </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/component-tabs.html') }}"> Tabs </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-accordion.html') }}"> Accordions  </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-modal.html') }}"> Modals </a>
                            </li>                            
                            <li>
                                <a href="{{ ('assets/component-cards.html') }}"> Cards </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-bootstrap-carousel.html') }}">Carousel</a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-splide.html') }}">Splide</a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-sweetalert.html') }}"> Sweet Alerts </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-timeline.html') }}"> Timeline </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-notifications.html') }}"> Notifications </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-media-object.html') }}"> Media Object </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-list-group.html') }}"> List Group </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-pricing-table.html') }}"> Pricing Tables </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-lightbox.html') }}"> Lightbox </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-drag-drop.html') }}"> Drag and Drop </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-fonticons.html') }}"> Font Icons </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/component-flags.html') }}"> Flag Icons </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="elements" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/element-alerts.html') }}"> Alerts </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-avatar.html') }}"> Avatar </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-badges.html') }}"> Badges </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-breadcrumbs.html') }}"> Breadcrumbs </a>
                            </li>                            
                            <li>
                                <a href="{{ ('assets/element-buttons.html') }}"> Buttons </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-buttons-group.html') }}"> Button Groups </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-color-library.html') }}"> Color Library </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-dropdown.html') }}"> Dropdown </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-infobox.html') }}"> Infobox </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-loader.html') }}"> Loader </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-pagination.html') }}"> Pagination </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-popovers.html') }}"> Popovers </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-progressbar.html') }}"> Progress Bar </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-search.html') }}"> Search </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-tooltips.html') }}"> Tooltips </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-treeview.html') }}"> Treeview </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/element-typography.html') }}"> Typography </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="{{ ('assets/map-leaflet.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ ('assets/charts-apex.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ ('assets/widgets.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="layouts" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/layout-blank-page.html') }}"> Blank Page </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/layout-empty.html') }}"> Empty Page </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/layout-boxed.html') }}"> Boxed </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/layout-collapsible-menu.html') }}"> Collapsed Menu </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ ('assets/table-basic.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="datatables" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/table-datatable-basic.html') }}"> Basic </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/table-datatable-striped-table.html') }}"> Striped </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/table-datatable-custom.html') }}"> Custom </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/table-datatable-miscellaneous.html') }}"> Miscellaneous </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/form-bootstrap-basic.html') }}"> Basic </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-input-group-basic.html') }}"> Input Group </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-layouts.html') }}"> Layouts </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-validation.html') }}"> Validation </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-input-mask.html') }}"> Input Mask </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-tom-select.html') }}"> Tom Select </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-tagify.html') }}"> Tagify </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-bootstrap-touchspin.html') }}"> TouchSpin </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-maxlength.html') }}"> Maxlength </a>
                            </li>                          
                            <li>
                                <a href="{{ ('assets/form-checkbox.html') }}"> Checkbox </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-radio.html') }}"> Radio </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-switches.html') }}"> Switches </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-wizard.html') }}"> Wizards </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-fileupload.html') }}"> File Upload </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-quill.html') }}"> Quill Editor </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-markdown.html') }}"> Markdown Editor </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-date-time-picker.html') }}"> Date Time Picker </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-slider.html') }}"> Slider </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-clipboard.html') }}"> Clipboard </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/form-autoComplete.html') }}"> Auto Complete </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/user-profile.html') }}"> Profile </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/user-account-settings.html') }}"> Account Settings </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="pages" data-bs-parent="#accordionExample">
                            <li class="active">
                                <a href="{{ ('assets/pages-knowledge-base.html') }}"> Knowledge Base </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/pages-faq.html') }}"> FAQ </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/pages-contact-us.html') }}"> Contact Form </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/pages-error404.html') }}" target="_blank"> Error </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/pages-maintenence.html') }}" target="_blank"> Maintanence </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ ('assets/auth-boxed-signin.html') }}" target="_blank"> Sign In </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-boxed-signup.html') }}" target="_blank"> Sign Up </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-boxed-lockscreen.html') }}" target="_blank"> Unlock </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-boxed-password-reset.html') }}" target="_blank"> Reset </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-boxed-2-step-verification.html') }}" target="_blank"> 2 Step </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-cover-signin.html') }}" target="_blank"> Sign In Cover </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-cover-signup.html') }}" target="_blank"> Sign Up Cover </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-cover-lockscreen.html') }}" target="_blank"> Unlock Cover </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-cover-password-reset.html') }}" target="_blank"> Reset Cover </a>
                            </li>
                            <li>
                                <a href="{{ ('assets/auth-cover-2-step-verification.html') }}" target="_blank"> 2 Step Cover </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        <a target="_blank" href="{{ ('assets/documentation/index.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a target="_blank" href="{{ ('assets/documentation/changelog.html') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
